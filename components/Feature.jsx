    ...
    <div className='overflow-y-hidden'>
      <div className="xl:mx-auto xl:container  xl:px-20 md:px-6 px-4 py-12">
        <div className="lg:flex items-center justify-center lg:space-x-12 2xl:space-x-6">
          <div className>
            <p className="lg:text-4xl text-3xl font-extrabold leading-9 text-gray-800">About us</p>
            <p className="text-lg leading-7 text-gray-600 mt-4 xl:w-7/12 w-full">We are here to fight your corner all the way</p>
            <div className="lg:hidden lg:w-3/5 xl:w-3/5 w-full lg:mt-0 mt-6">
              <img src="/box-bg-image1." alt="ongoing meeting" className="w-full obejct-fit object-center object-fill h-full" />
            </div>
          ...
          <div className="hidden lg:block lg:w-3/5 xl:w-3/5 w-full lg:mt-0 mt-6">
            <img src="/box-bg-image1.jpg" alt="ongoing meeting" className="w-full obejct-fit object-center object-fill h-full" />
          </div>
        </div>
      </div>
    </div>
